...
def b_login(root,txt1,txt2):
   mydb = con.connect(host="localhost",user="root",passwd="anurag",database="lbms")
    
   mycursor = mydb.cursor()
   qr="select * from student where username='{0}' and password='{1}'".format(txt1.get(),txt2.get())
...
def new_win3():
        ...
        lb2=Label(r,text="Student Login",font=("Arial Bold",20),bg="red", fg="blue")
        ...
        btn=Button(r,text="Log In",command=lambda:b_login(r,txt1,txt2),font=("Arial Bold",10),bg="yellow", fg="black")
